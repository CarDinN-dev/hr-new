  ...
  return <section className="stack">
    ...
    <div className="panel">
      ...
      {events.isPending ? <p className="muted">Loading audit history…</p> : events.isError ? <p className="sync-alert">{events.error.message}</p> : <>
        ...
        <Pagination total={total} page={page} limit={pagination.limit} totalPages={totalPages} label="entries" loading={events.isFetching} onPage={nextPage => setPagination(previous => ({ ...previous, page: nextPage }))}>
