...
export class ServiceRequestsController {
  ...
  @AnyPermission('service_request.hr.approve', 'service_request.override') @Post(':id/approve') approve(@Param('id') id: string, @Body() dto: ServiceRequestTransitionDto, @Headers('idempotency-key') key: string | undefined, @CurrentUser() user: RequestUser) { return this.service.approve(id, dto, key, user); }
