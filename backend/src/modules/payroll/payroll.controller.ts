...
export class PayrollController {
  ...
  @PayrollRoles('HR', 'CPO', 'COO') @Permissions('payroll.read') @Get('adjustments') adjustments(@Query() query: QueryPayrollAdjustmentsDto, @CurrentUser() user: RequestUser) { return this.payroll.listAdjustments(query, user); }
  ...
  @PayrollRoles('HR', 'CPO', 'COO') @AnyPermission('payroll.read', 'payroll.audit.read') @Get('runs') runs(@Query() query: QueryPayrollDto, @CurrentUser() user: RequestUser) { return this.payroll.listRuns(query, user); }
  @PayrollRoles('HR', 'CPO', 'COO') @AnyPermission('payroll.read', 'payroll.audit.read') @Get('runs/:id') run(@Param('id') id: string, @CurrentUser() user: RequestUser) { return this.payroll.findRun(id, user); }
  ...
  @PayrollRoles('HR', 'CPO', 'COO') @Permissions('payroll.export') @Get('departments') departments(@CurrentUser() user: RequestUser) { return this.payroll.listExportDepartments(user); }
  ...
  @PayrollRoles('HR', 'CPO', 'COO') @Permissions('payroll.payslip.read_all') @Get('payslips') payslips(@Query() query: QueryPayrollDto, @CurrentUser() user: RequestUser) { return this.payroll.listPayslips(query, user); }
  ...
  @PayrollRoles('HR', 'CPO', 'COO') @Permissions('payroll.export') @Get('runs/:id/export') async exportRun(@Param('id') id: string, @Query('departmentId') departmentId: string | undefined, @CurrentUser() user: RequestUser, @Res() response: Response) {
