...
- Systemd runs the Cloudflare service, hourly database backups, hourly policy-gated audit pruning, and the five-minute health publisher. Google Cloud Monitoring checks the public health endpoint and alerts on component, resource, backup, scanner, and authentication failures.
